...
draw_set_halign(fa_left)
	...
	var _x=x+(width)-(sprite_get_width(sTextbox))*6
	var _y=y+op_border
	...
	draw_text_outline(_x,_y,_txt,_sep,_w)
	draw_text_ext(_x,_y,_txt,_sep,_w)
	
	draw_set_halign(fa_center)
	draw_set_valign(fa_middle)
	var _x=x+(width)-(sprite_get_width(sTextbox))*3
	var _y=y+(height)-op_border*2
	var _txt=string(pos_mis_txt+1)+"/"+string((omission_manager.mis_prog[global.mission_inv[pos_mis]])+1)
	draw_text_outline(_x,_y,_txt)
