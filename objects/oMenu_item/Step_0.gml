...
if _can_wfora and array_length(inv[pos_inv])>0 and member_item_mode=0 and options_item_mode=0{
	...
	if wfora{
		if vender_mode{global.exp+=inv[pos_inv][pos_item].price
...
if member_item_pos >= global.party_length {member_item_pos=0}
if member_item_pos < 0 {member_item_pos= global.party_length-1}
