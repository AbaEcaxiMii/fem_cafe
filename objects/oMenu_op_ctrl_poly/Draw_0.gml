...
for(var i=0;i<op_length;i++){
	...
	outline_text(x+op_border +(op_space*7),y+op_border + op_space*i,status[i])
	draw_text_color(x+op_border +(op_space*7),y+op_border + op_space*i,status[i],_c,_c,_c,_c,1)
	//if global.language=0{
	...
	outline_text(x+op_border,y+op_border + op_space*10,"Default (Press F5)")
	draw_text(x+op_border,y+op_border + op_space*10,"Default (Press F5)")
}
